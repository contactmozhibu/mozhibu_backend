...
router.get("/", optionalAuth, async (req, res) => {
  try {
    ...
    console.log("🔍 QUERY PARAMS:", { category, language, ageCategory, contentType, subcategory });
    ...
    // Content type filtering (Erotic/Non-Erotic) - ✅ FIXED FIELD NAME
    if (contentType) {
...
// ✅ UPDATE PUBLISHED STORY ENDPOINT
router.put("/:id", authMiddleware, async (req, res) => {
  try {
    ...
    if (req.body.subcategories) story.subcategories = req.body.subcategories;

    await story.save();

    console.log("✅ Story updated successfully:", story._id);
...
router.put("/:id", authMiddleware, async (req, res) => {
  try {
    console.log("UPDATE STORY ID:", req.params.id);
